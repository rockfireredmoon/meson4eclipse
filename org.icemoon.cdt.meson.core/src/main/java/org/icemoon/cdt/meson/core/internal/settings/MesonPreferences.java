...
import org.icemoon.cdt.meson.core.internal.storage.ProjectOptionSerializer;
import org.icemoon.cdt.meson.core.internal.storage.Util;
...
public class MesonPreferences {
	 ...
	 */
	public static final String CFG_STORAGE_ID = CdtPlugin.PLUGIN_ID + ".settings";
	...
	public void loadFromStorage(ICStorageElement parent) {
		...
		for (ICStorageElement child : children) {
			if (ELEM_OPTIONS.equals(child.getName())) {
				...
				crossFile = child.getAttribute(ATTR_CACHE_FILE);
	...
	public void saveToStorage(ICStorageElement parent) {
		...
		if (crossFile != null) {
			pOpts.setAttribute(ATTR_CACHE_FILE, crossFile);
		} else {
