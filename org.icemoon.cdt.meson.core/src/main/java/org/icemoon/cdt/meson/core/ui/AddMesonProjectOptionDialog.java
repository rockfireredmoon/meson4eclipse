...
import org.icemoon.cdt.meson.core.internal.settings.MesonProjectOptionType;
...
public class AddMesonProjectOptionDialog extends Dialog {
	...
	/**
	 * Gets the edited or newly created meson define.
	 *
	 * @return the modified or new ProjectOption or {@code null} if this dialog has
	 *         been cancelled.
	 */
	public ProjectOption getCmakeDefine() {
		return editedVar;
	}
	...
	protected void configureShell(Shell shell) {
		...
		if (editedVar != null)
			shell.setText("Edit existing Meson Project Option");
		else
			shell.setText("Add new Meson Project Option");
	}
	...
	/**
	 * Converts an index in {@link AddMesonProjectOptionDialog#typeNames} to a Cmake
	 * variable type.
	 *
