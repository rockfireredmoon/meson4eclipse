...
public class NewMesonProjectWizard extends TemplateWizard {
	...
	public void addPages() {
		...
		mainPage.setTitle(Messages.NewMesonProjectWizard_Title);
	...
	protected IGenerator getGenerator() {
		MesonProjectGenerator generator = new MesonProjectGenerator("templates/meson/manifest.xml"); //$NON-NLS-1$
