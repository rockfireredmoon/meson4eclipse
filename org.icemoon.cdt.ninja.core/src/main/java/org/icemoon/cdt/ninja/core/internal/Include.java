...
public class Include extends Parent implements IInclude {
	...
	public Include(Directive parent, String filename) {
		super(parent);
	...
	public String toString() {
		StringBuilder sb = new StringBuilder(NinjaFileConstants.DIRECTIVE_INCLUDE);
		if (filename != null) {
	...
	public String[] getFilenames() {
		return filename == null ? new String[0] : new String[] { filename };
	}
}
