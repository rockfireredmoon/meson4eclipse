...
public class PosixMakefileUtil {
	...
	public static boolean isDefaultRule(String line) {
		...
		if (colon > 0) {
			...
			return line.equals(NinjaConstants.RULE_DEFAULT);
		}
		return false;
	}
	...
	public static boolean isIgnoreRule(String line) {
		...
		if (colon > 0) {
			line = line.substring(0, colon).trim();
			return line.equals(NinjaConstants.RULE_IGNORE);
		}
		return false;
	}
	...
	public static boolean isPosixRule(String line) {
		...
		if (colon > 0) {
			line = line.substring(0, colon).trim();
			return line.equals(NinjaConstants.RULE_POSIX);
		}
		return false;
	}
	...
	public static boolean isPreciousRule(String line) {
		...
		if (colon > 0) {
			line = line.substring(0, colon).trim();
			return line.equals(NinjaConstants.RULE_PRECIOUS);
		}
		return false;
	}
	...
	public static boolean isSccsGetRule(String line) {
		...
		if (colon > 0) {
			line = line.substring(0, colon).trim();
			return line.equals(NinjaConstants.RULE_SCCS_GET);
		}
		return false;
	}
	...
	public static boolean isSilentRule(String line) {
		...
		if (colon > 0) {
			line = line.substring(0, colon).trim();
			return line.equals(NinjaConstants.RULE_SILENT);
		}
		return false;
	}
	...
	public static boolean isSuffixesRule(String line) {
		...
		if (colon > 0) {
			line = line.substring(0, colon).trim();
			return line.equals(NinjaConstants.RULE_SUFFIXES);
		}
		return false;
	}
