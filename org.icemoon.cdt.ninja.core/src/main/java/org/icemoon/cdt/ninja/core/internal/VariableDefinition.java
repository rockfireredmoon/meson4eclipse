...
public class VariableDefinition extends MacroDefinition implements IVariableDefinition  {
	 ...
	 */
	public final static int TYPE_RECURSIVE_EXPAND = 0;
	public final static int TYPE_SIMPLE_EXPAND = ':';
	public final static int TYPE_CONDITIONAL = '?';
	public final static int TYPE_APPEND = '+';
	int type;
	String varTarget;
	...
	public String toString() {
		...
		if (isMultiLine()) {
			...
			if (isExport()) {
				sb.append(NinjaFileConstants.VARIABLE_EXPORT);
				sb.append(' ');
			}
			sb.append(getName());
