...
class ParserDetection {
	...
	static {
		...
		final IToolArgumentParser[] posix_cc_args = { new ToolArgumentParsers.IncludePath_C_POSIX(),
				...
				new ToolArgumentParsers.SystemIncludePath_C(), new ToolArgumentParsers.LibraryPath_C_POSIX() };
	...
	private static String expandShortFileName(String commandLine) {
		...
		try {
			...
			log.log(new Status(IStatus.ERROR, NinjaPlugin.PLUGIN_ID, "CompileCommandsJsonParser#expandShortFileName()",
					e));
		}
		return null;
	}
