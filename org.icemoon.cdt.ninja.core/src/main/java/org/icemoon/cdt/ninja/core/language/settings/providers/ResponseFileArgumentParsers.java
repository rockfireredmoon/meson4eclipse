...
import org.icemoon.cdt.ninja.core.language.settings.providers.ToolArgumentParsers.NameOptionMatcher;
...
class ResponseFileArgumentParsers {
	...
	static class At implements IResponseFileArgumentParser {
		 ...
		 * (non-Javadoc)
		 *
		 * @see org.icemoon.cdt.meson.ui.language.settings.providers.
		 * IResponseFileArgumentParser
		 * #process(org.icemoon.cdt.meson.ui.language.settings.providers.IParserHandler,
		 * java.lang.String)
		 */
		@Override
