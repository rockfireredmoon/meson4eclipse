...
public class NinjaManagedProjectNature implements IProjectNature {
	...
	public void addBuildSpec() throws CoreException {
		addToBuildSpec(getProject(), BUILDER_ID, null);
	}

	@Override
	public void configure() throws CoreException {
		addBuildSpec();
		IMakeBuilderInfo info = NinjaPlugin.createBuildInfo(NinjaPlugin.getDefault().getPluginPreferences(), BUILDER_ID,
				false);
		IMakeBuilderInfo projectInfo = NinjaPlugin.createBuildInfo(getProject(), BUILDER_ID);
		...
		projectInfo.setBuildAttribute(IMakeCommonBuildInfo.BUILD_COMMAND,
				info.getBuildAttribute(IMakeCommonBuildInfo.BUILD_COMMAND, "ninja")); //$NON-NLS-1$
	...
	public void removeBuildSpec() throws CoreException {
		removeFromBuildSpec(getProject(), BUILDER_ID, null);
	}
