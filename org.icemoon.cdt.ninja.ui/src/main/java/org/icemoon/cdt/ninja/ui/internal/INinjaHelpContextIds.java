 ...
 */
public interface INinjaHelpContextIds {
	public static final String PREFIX = NinjaUIPlugin.getUniqueIdentifier() + "."; //$NON-NLS-1$
	...
	public static final String NINJA_EDITOR_PREFERENCE_PAGE = PREFIX + "ninja_editor_pref"; //$NON-NLS-1$
	/**
	 * @since 7.1
	 */
