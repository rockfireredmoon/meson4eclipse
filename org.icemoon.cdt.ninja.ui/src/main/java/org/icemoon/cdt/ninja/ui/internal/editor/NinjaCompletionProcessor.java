 ...
 */
public class NinjaCompletionProcessor implements IContentAssistProcessor {
	/**
	...
	protected Image imageFunction = NinjaUIImages.getImage(NinjaUIImages.IMG_OBJS_FUNCTION);
	protected Image imageVariable = CDTSharedImages.getImage(CDTSharedImages.IMG_OBJS_VARIABLE);
	protected Image imageAutomaticVariable = NinjaUIImages.getImage(NinjaUIImages.IMG_OBJS_AUTO_VARIABLE);
	protected Image imageTarget = NinjaUIImages.getImage(NinjaUIImages.IMG_OBJS_TARGET);
	...
	public NinjaCompletionProcessor(IEditorPart editor) {
		fEditor = editor;
