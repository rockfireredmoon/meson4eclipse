...
public class ProjectionMakefileUpdater implements IProjectionListener {
	...
	public void install(NinjaFileEditor editor, ProjectionViewer viewer) {
		fEditor = editor;
		fViewer = viewer;
	...
	private void initializePreferences() {
		...
		fCollapseMacroDef = store.getBoolean(NinjaFileEditorPreferenceConstants.EDITOR_FOLDING_MACRODEF);
		fCollapseRule = store.getBoolean(NinjaFileEditorPreferenceConstants.EDITOR_FOLDING_RULE);
		fCollapseConditional = store.getBoolean(NinjaFileEditorPreferenceConstants.EDITOR_FOLDING_CONDITIONAL);
	}
