...
class VariableDefinitionRule implements IPredicateRule {
	...
	public VariableDefinitionRule(IToken token, IToken defaultToken) {
		this.token = token;
	...
	protected boolean isValidCharacter(int c) {
		...
		// they cannot be passed through the environment to a sub-make
