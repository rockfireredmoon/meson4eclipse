...
import org.icemoon.cdt.ninja.core.language.settings.providers.AbstractParser;
 ...
 */
public abstract class AbstractParserOptionPage<P extends AbstractParser> extends AbstractCOptionPage {
	...
	public void performApply(IProgressMonitor monitor) throws CoreException {
		...
		try {
			...
			// IStatus status = new Status(IStatus.ERROR, MesonPlugin.PLUGIN_ID,
			// IStatus.OK,
			// "invalid suffix pattern in MESON_EXPORT_COMPILE_COMMANDS Parser", ex);
			// throw new CoreException(status);

			throw new PatternSyntaxException(
					"invalid suffix pattern in Meson Compile Commands Parser: " + ex.getDescription(), ex.getPattern(),
					ex.getIndex());
		}
	}
